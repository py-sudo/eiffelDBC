...
extern void F990_7652(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F990_7656(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F990_7675(EIF_REFERENCE);
...
/* {DATE_TIME_CODE}.make */
void F990_7652 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 989, Current, 0, 1, 13930);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(989, Current, 13930);
...
EIF_TYPED_VALUE F990_7653 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 989, Current, 0, 0, 13931);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(989, Current, 13931);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F990_7656 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 989, Current, 1, 1, 13934);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(989, Current, 13934);
	RTCC(arg1, 989, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5362, 0xF80000E8, 0); /* value */
	...
	*(EIF_REFERENCE *)(Current + RTWA(5362, dtype)) = (EIF_REFERENCE) tr1;
	...
	if (tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 5363, 0x10000000, 1); /* count_max */
		*(EIF_INTEGER_32 *)(Current + RTWA(5363, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		RTHOOK(6);
		RTDBGAA(Current, dtype, 5364, 0x10000000, 1); /* count_min */
		*(EIF_INTEGER_32 *)(Current + RTWA(5364, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		...
		RTHOOK(8);
		RTDBGAA(Current, dtype, 5366, 0x10000000, 1); /* value_max */
		*(EIF_INTEGER_32 *)(Current + RTWA(5366, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 31L);
		RTHOOK(9);
		RTDBGAA(Current, dtype, 5367, 0x10000000, 1); /* value_min */
		*(EIF_INTEGER_32 *)(Current + RTWA(5367, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 5359, 0x04000000, 1); /* is_text */
		*(EIF_BOOLEAN *)(Current + RTWA(5359, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
		RTHOOK(11);
		RTDBGAA(Current, dtype, 5360, 0x04000000, 1); /* is_numeric */
		*(EIF_BOOLEAN *)(Current + RTWA(5360, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		RTHOOK(12);
		RTDBGAA(Current, dtype, 5368, 0x10000000, 1); /* type */
		tu1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5369, dtype))(Current)).it_n1);
		ti4_1 = (EIF_INTEGER_32) tu1_1;
		*(EIF_INTEGER_32 *)(Current + RTWA(5368, dtype)) = (EIF_INTEGER_32) ti4_1;
	} else {
		RTHOOK(13);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5362, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
		...
		if (tb1) {
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(5363, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
			RTHOOK(15);
			RTDBGAA(Current, dtype, 5364, 0x10000000, 1); /* count_min */
			*(EIF_INTEGER_32 *)(Current + RTWA(5364, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
			RTHOOK(16);
			RTDBGAL(1, 0xF80000E8, 0, 0); /* loc1 */
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(5368, dtype)) = (EIF_INTEGER_32) ti4_1;
			...
			if (tb1) {
				RTHOOK(23);
				RTDBGAA(Current, dtype, 5363, 0x10000000, 1); /* count_max */
				*(EIF_INTEGER_32 *)(Current + RTWA(5363, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
				RTHOOK(24);
				RTDBGAA(Current, dtype, 5364, 0x10000000, 1); /* count_min */
				*(EIF_INTEGER_32 *)(Current + RTWA(5364, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
				RTHOOK(25);
				RTDBGAL(1, 0xF80000E8, 0, 0); /* loc1 */
				...
				RTHOOK(26);
				RTDBGAA(Current, dtype, 5366, 0x10000000, 1); /* value_max */
				*(EIF_INTEGER_32 *)(Current + RTWA(5366, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 7L);
				RTHOOK(27);
				RTDBGAA(Current, dtype, 5367, 0x10000000, 1); /* value_min */
				*(EIF_INTEGER_32 *)(Current + RTWA(5367, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
				RTHOOK(28);
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(5368, dtype)) = (EIF_INTEGER_32) ti4_1;
				...
				if (tb1) {
					RTHOOK(32);
					RTDBGAA(Current, dtype, 5363, 0x10000000, 1); /* count_max */
					*(EIF_INTEGER_32 *)(Current + RTWA(5363, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
					RTHOOK(33);
					RTDBGAA(Current, dtype, 5364, 0x10000000, 1); /* count_min */
					*(EIF_INTEGER_32 *)(Current + RTWA(5364, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
					RTHOOK(34);
					RTDBGAL(1, 0xF80000E8, 0, 0); /* loc1 */
						...
						*(EIF_INTEGER_32 *)(Current + RTWA(5367, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
						...
						if (tb1) {
							...
							*(EIF_INTEGER_32 *)(Current + RTWA(5364, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
							...
							RTHOOK(53);
							RTDBGAA(Current, dtype, 5366, 0x10000000, 1); /* value_max */
							*(EIF_INTEGER_32 *)(Current + RTWA(5366, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 12L);
							RTHOOK(54);
							RTDBGAA(Current, dtype, 5367, 0x10000000, 1); /* value_min */
							*(EIF_INTEGER_32 *)(Current + RTWA(5367, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
							RTHOOK(55);
									...
									*(EIF_INTEGER_32 *)(Current + RTWA(5368, dtype)) = (EIF_INTEGER_32) ti4_1;
									...
									if (tb1) {
										...
										*(EIF_INTEGER_32 *)(Current + RTWA(5364, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
										...
										RTHOOK(80);
										RTDBGAA(Current, dtype, 5366, 0x10000000, 1); /* value_max */
										*(EIF_INTEGER_32 *)(Current + RTWA(5366, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 24L);
										RTHOOK(81);
										RTDBGAA(Current, dtype, 5367, 0x10000000, 1); /* value_min */
												...
												*(EIF_INTEGER_32 *)(Current + RTWA(5368, dtype)) = (EIF_INTEGER_32) ti4_1;
												...
												if (tb1) {
													...
													*(EIF_INTEGER_32 *)(Current + RTWA(5364, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
													...
													RTHOOK(107);
													RTDBGAA(Current, dtype, 5366, 0x10000000, 1); /* value_max */
													*(EIF_INTEGER_32 *)(Current + RTWA(5366, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 59L);
													RTHOOK(108);
													RTDBGAA(Current, dtype, 5367, 0x10000000, 1); /* value_min */
													*(EIF_INTEGER_32 *)(Current + RTWA(5367, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
													RTHOOK(109);
																				...
																				*(EIF_INTEGER_32 *)(Current + RTWA(5368, dtype)) = (EIF_INTEGER_32) ti4_1;
																				...
																				if (tb1) {
																					...
																					*(EIF_BOOLEAN *)(Current + RTWA(5360, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
																					RTHOOK(175);
																					RTDBGAA(Current, dtype, 5368, 0x10000000, 1); /* type */
																					tu1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5389, dtype))(Current)).it_n1);
																					ti4_1 = (EIF_INTEGER_32) tu1_1;
																					*(EIF_INTEGER_32 *)(Current + RTWA(5368, dtype)) = (EIF_INTEGER_32) ti4_1;
																				} else {
																					RTHOOK(176);
																					...
																					if (tb1) {
																						...
																						*(EIF_BOOLEAN *)(Current + RTWA(5360, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
																						RTHOOK(182);
																						RTDBGAA(Current, dtype, 5368, 0x10000000, 1); /* type */
																						tu1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5390, dtype))(Current)).it_n1);
																						ti4_1 = (EIF_INTEGER_32) tu1_1;
																						*(EIF_INTEGER_32 *)(Current + RTWA(5368, dtype)) = (EIF_INTEGER_32) ti4_1;
																					} else {
																						RTHOOK(183);
																						...
																						if (tb1) {
																							...
																							*(EIF_BOOLEAN *)(Current + RTWA(5360, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
																							RTHOOK(189);
																							RTDBGAA(Current, dtype, 5368, 0x10000000, 1); /* type */
																							tu1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5391, dtype))(Current)).it_n1);
																							ti4_1 = (EIF_INTEGER_32) tu1_1;
																							*(EIF_INTEGER_32 *)(Current + RTWA(5368, dtype)) = (EIF_INTEGER_32) ti4_1;
																						} else {
																							RTHOOK(190);
																							...
																							if (tb1) {
																								...
																								*(EIF_BOOLEAN *)(Current + RTWA(5360, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
																								RTHOOK(196);
																								RTDBGAA(Current, dtype, 5368, 0x10000000, 1); /* type */
																								tu1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5392, dtype))(Current)).it_n1);
																								ti4_1 = (EIF_INTEGER_32) tu1_1;
																								*(EIF_INTEGER_32 *)(Current + RTWA(5368, dtype)) = (EIF_INTEGER_32) ti4_1;
																							} else {
																								if (RTAL & CK_CHECK) {
	...
	RTHOOK(206);
	RTDBGAA(Current, dtype, 5365, 0xF80000E8, 0); /* name */
	tr1 = RTCCL(loc1);
	RTAR(Current, tr1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 989, Current, 0, 0, 13942);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F990_7675 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT8;
