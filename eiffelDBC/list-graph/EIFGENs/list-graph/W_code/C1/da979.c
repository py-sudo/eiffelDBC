...
extern EIF_TYPED_VALUE F979_7469(EIF_REFERENCE);
...
EIF_TYPED_VALUE F979_7469 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 978, Current, 0, 0, 13743);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(978, Current, 13743);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5200, "fractional_second", tr1));
