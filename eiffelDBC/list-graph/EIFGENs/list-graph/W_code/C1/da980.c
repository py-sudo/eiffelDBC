...
extern EIF_TYPED_VALUE F980_7479(EIF_REFERENCE);
...
EIF_TYPED_VALUE F980_7479 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 13746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 13746);
	RTIV(Current, RTAL);
	RTHOOK(1);
