...
void F581_3978 (EIF_REFERENCE Current)
{
	...
	tr1 = *(EIF_REFERENCE *)(Current + _REFACS_2_);
	F474_3224(RTCW(tr1), ((EIF_INTEGER_32) -1L), ((EIF_INTEGER_32) 0L), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_1_));
