...
#define Result RTOTRR
	...
	RTOTP;
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,102,831,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(Dftype(Current), typarr0)));
		tr1 = RTLNS(typres0.id, 102, _OBJSIZ_0_0_0_0_0_0_1_0_);
	}
	F103_1934(RTCW(tr1), (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L));
