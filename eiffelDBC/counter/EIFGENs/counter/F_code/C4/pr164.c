...
EIF_REFERENCE F616_4276 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	F503_3306(RTCW(Result), (EIF_BOOLEAN) 0, ((EIF_INTEGER_32) 1L), arg1);
	loc1 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	for (;;) {
		if ((EIF_BOOLEAN) (loc1 > arg1)) break;
		F503_3330(RTCW(Result), (EIF_BOOLEAN) 1, loc1);
		loc1 += ((EIF_INTEGER_32) 2L);
	}
	if ((EIF_BOOLEAN) (arg1 >= ((EIF_INTEGER_32) 2L))) {
		F503_3330(RTCW(Result), (EIF_BOOLEAN) 1, ((EIF_INTEGER_32) 2L));
	}
	loc1 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	for (;;) {
		if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 * loc1) > arg1)) break;
		tb1 = F503_3311(RTCW(Result), loc1);
		if (tb1) {
			loc2 = (EIF_INTEGER_32) (EIF_INTEGER_32) (loc1 * loc1);
			for (;;) {
				if ((EIF_BOOLEAN) (loc2 > arg1)) break;
				F503_3330(RTCW(Result), (EIF_BOOLEAN) 0, loc2);
...
EIF_INTEGER_32 F616_4278 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	if (tb1) {
		ti4_1 = F505_3311(RTCW(loc3), arg1);
		RTLE;
		...
		for (;;) {
			if ((EIF_BOOLEAN)(loc2 == arg1)) break;
			Result++;
			tb1 = F503_3311(RTCW(loc1), Result);
			if (tb1) {
				loc2++;
			}
		}
...
#define Result RTOTRR
	...
	loc1 = F616_4276(Current, ti4_1);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,504,828,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
	...
	F505_3306(RTCW(tr1), ((EIF_INTEGER_32) 0L), ((EIF_INTEGER_32) 1L), ((EIF_INTEGER_32) 200L));
	Result = (EIF_REFERENCE) tr1;
	loc3 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
	loc2 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
	for (;;) {
		if ((EIF_BOOLEAN) (loc3 > ((EIF_INTEGER_32) 200L))) break;
		tb1 = F503_3311(RTCW(loc1), loc2);
		if (tb1) {
			F505_3330(RTCW(Result), loc2, loc3);
			loc3++;
		}
		loc2++;
	}
