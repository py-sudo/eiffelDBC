...
void F584_4043 (EIF_REFERENCE Current)
{
	GTCX
	RTLD;
	...
	RTOUCP(11,F584_4053, (Current));
	RTLE;
}

/* {MISMATCH_INFORMATION}.class_name */
EIF_REFERENCE F584_4044 (EIF_REFERENCE Current)
{
	GTCX
	...
	tr1 = RTOUCR(12,F584_4047, (Current));
...
EIF_REFERENCE F584_4047 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F584_4050 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	ti4_1 = *(EIF_INTEGER_32 *)(RTCV(F584_4044(Current))+ _LNGOFF_1_1_0_2_);
	...
	for (;;) {
		...
		if (!RTEQ(loc2, RTOUCR(12,F584_4047, (Current)))) {
...
void F584_4051 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_POINTER arg2)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
...
void F584_4052 (EIF_REFERENCE Current, EIF_POINTER arg1, EIF_POINTER arg2)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_POINTER tp1;
...
static void F584_4053_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEV;
	RTOTP;
	F584_4054(Current, Current, (EIF_POINTER) F577_3978, (EIF_POINTER) F584_4051, (EIF_POINTER) F584_4052);
	RTOTE;
	RTEE;
#undef Result
}

void F584_4053 (EIF_REFERENCE Current)
{
	GTCX
	RTOUCP(11,F584_4053_body,(Current));
}

/* {MISMATCH_INFORMATION}.set_mismatch_information_access */
void F584_4054 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_POINTER arg2, EIF_POINTER arg3, EIF_POINTER arg4)
{
	GTCX
	RTLD;
