...
/* {ARRAYED_LIST}.item */
EIF_POINTER F587_4078 (EIF_REFERENCE Current)
{
	GTCX
	EIF_POINTER tp1;
	EIF_POINTER tp2;
...
/* {ARRAYED_LIST}.i_th */
EIF_POINTER F587_4079 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	EIF_POINTER tp1;
	EIF_POINTER tp2;
		...
		if (tb1) {
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
				...
				for (;;) {
					...
					if (tb1) break;
					tp1 = F587_4079(Current, loc1);
					tp2 = F587_4079(RTCW(arg1), loc1);
