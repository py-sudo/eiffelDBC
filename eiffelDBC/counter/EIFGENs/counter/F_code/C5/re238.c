...
void F875_6847 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	*(EIF_INTEGER_32 *)(Current + O4734[dtype-870]) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,472,798,0xFFFF};
		EIF_TYPE typres0;
	...
	F473_3203(RTCW(tr1), tw1, (EIF_INTEGER_32) (arg1 + ((EIF_INTEGER_32) 1L)));
	RTAR(Current, tr1);
	...
	if ((EIF_BOOLEAN)(arg1 == Current)) {
		...
		if ((EIF_BOOLEAN)(loc1 == ti4_1)) {
			...
			if ((EIF_BOOLEAN) ((EIF_BOOLEAN) ((EIF_BOOLEAN)(loc2 == ((EIF_INTEGER_32) 0L)) || (EIF_BOOLEAN)(loc3 == ((EIF_INTEGER_32) 0L))) || (EIF_BOOLEAN)(loc2 == loc3))) {
				...
				Result = F473_3218(RTCW(tr1), tr2, ti4_1, ti4_2, loc1);
			}
		}
	}
	RTLE;
...
void F875_6885 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(arg1 != Current)) {
		...
		if (tb1) {
			tr1 = *(EIF_REFERENCE *)(Current);
			tr1 = F473_3235(RTCW(tr1), (EIF_INTEGER_32) (*(EIF_INTEGER_32 *)(Current + O4910[dtype-874]) + ((EIF_INTEGER_32) 1L)));
			RTAR(Current, tr1);
			*(EIF_REFERENCE *)(Current) = (EIF_REFERENCE) tr1;
		} else {
			/* INLINED CODE (SPECIAL.copy_data) */
