...
/* {LINKED_LIST}.item */
EIF_BOOLEAN F573_3637 (EIF_REFERENCE Current)
{
	GTCX
...
/* {LINKED_LIST}.extend */
void F573_3662 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_REFERENCE loc2 = (EIF_REFERENCE) 0;
	...
	if ((EIF_BOOLEAN)(arg1 != Current)) {
		...
		if ((EIF_BOOLEAN) !tb1) {
			...
			for (;;) {
				...
				if (tb1) break;
				tb2 = F573_3637(RTCW(arg1));
				F573_3662(Current, tb2);
				F573_3655(Current);
				F573_3656(RTCW(arg1));
			}
			if ((EIF_BOOLEAN)(loc1 != NULL)) {
...
EIF_REFERENCE F573_3674 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	RTLD;
	...
	RTGC;
	{
		...
		typres0 = eif_compound_id(Dftype(Current), typarr0);
		tr1 = RTLNS(typres0.id, 105, _OBJSIZ_1_1_0_0_0_0_0_0_);
	}
	F102_1934(RTCW(tr1), arg1);
	RTLE;
	return (EIF_REFERENCE) tr1;
}
