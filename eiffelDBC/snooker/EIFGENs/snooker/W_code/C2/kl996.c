...
extern EIF_TYPED_VALUE F996_12938(EIF_REFERENCE);
...
RTOID (F996_12938)
EIF_TYPED_VALUE F996_12938 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 995, Current, 0, 0, 13832);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(995, Current, 13832);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
