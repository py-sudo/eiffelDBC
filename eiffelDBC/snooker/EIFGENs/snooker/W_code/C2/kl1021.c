...
extern EIF_TYPED_VALUE F1021_13316(EIF_REFERENCE);
...
RTOID (F1021_13316)
EIF_TYPED_VALUE F1021_13316 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1020, Current, 0, 0, 14183);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1020, Current, 14183);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
