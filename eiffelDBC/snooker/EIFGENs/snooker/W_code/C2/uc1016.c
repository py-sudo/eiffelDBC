...
extern EIF_TYPED_VALUE F1016_13234(EIF_REFERENCE);
...
RTOID (F1016_13234)
EIF_TYPED_VALUE F1016_13234 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1015, Current, 0, 0, 14100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1015, Current, 14100);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
