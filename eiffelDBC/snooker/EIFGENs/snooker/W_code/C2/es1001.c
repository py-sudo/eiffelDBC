...
extern void F1001_12960(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1001_12961(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1001_12962(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1001_12963(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1001_12964(EIF_REFERENCE);
...
void F1001_12960 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1000, Current, 0, 2, 13851);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1000, Current, 13851);
...
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9914, 0xF800010A, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
	...
	*(EIF_REFERENCE *)(Current + RTWA(9910, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 9912, 0xF80000E8, 0); /* violation_tag */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(9912, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 9916, 0xF80000E8, 0); /* expected_tag_name */
...
void F1001_12961 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1000, Current, 0, 3, 13852);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1000, Current, 13852);
	RTCC(arg1, 1000, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,266,0xFF01,0xFFF9,0,186,0xFFFF};
		EIF_TYPE typres0;
...
void F1001_12962 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1000, Current, 3, 0, 13853);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1000, Current, 13853);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 9908, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(9908, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
	...
	ur1 = RTCCL(tr1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9916, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur2 = RTCCL(tr2);
	...
	if (tb1) {
		RTHOOK(6);
		RTDBGAA(Current, dtype, 9908, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(9908, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	} else {
		RTHOOK(7);
		RTDBGAA(Current, dtype, 9909, 0x04000000, 1); /* contract_violated */
		...
		*(EIF_REFERENCE *)(Current + RTWA(9912, dtype)) = (EIF_REFERENCE) tr1;
		RTHOOK(10);
		RTDBGAA(Current, dtype, 9913, 0x10000000, 1); /* violation_type */
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1255, dtype))(Current)).it_i4);
		*(EIF_INTEGER_32 *)(Current + RTWA(9913, dtype)) = (EIF_INTEGER_32) ti4_1;
	}
	RTHOOK(11);
...
EIF_TYPED_VALUE F1001_12963 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1000, Current, 0, 0, 13854);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1000, Current, 13854);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1001_12964 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
