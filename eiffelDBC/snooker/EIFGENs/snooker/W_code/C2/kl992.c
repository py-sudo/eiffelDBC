...
extern EIF_TYPED_VALUE F992_12865(EIF_REFERENCE);
...
RTOID (F992_12865)
EIF_TYPED_VALUE F992_12865 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 991, Current, 0, 0, 13759);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(991, Current, 13759);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
