...
extern EIF_TYPED_VALUE F989_12860(EIF_REFERENCE);
...
RTOID (F989_12860)
EIF_TYPED_VALUE F989_12860 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 988, Current, 0, 0, 13754);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(988, Current, 13754);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
