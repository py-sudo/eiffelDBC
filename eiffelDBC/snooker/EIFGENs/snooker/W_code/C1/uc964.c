...
extern EIF_TYPED_VALUE F964_12625(EIF_REFERENCE);
...
RTOID (F964_12625)
EIF_TYPED_VALUE F964_12625 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13573);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
