...
extern EIF_TYPED_VALUE F988_12859(EIF_REFERENCE);
...
RTOID (F988_12859)
EIF_TYPED_VALUE F988_12859 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 987, Current, 0, 0, 13753);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(987, Current, 13753);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
