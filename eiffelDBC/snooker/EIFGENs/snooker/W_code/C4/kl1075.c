/*
 * Code for class KL_TYPE [INTEGER_8]
 */
...
extern EIF_TYPED_VALUE F1075_13665(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1075_13666(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1075_13665 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui1_2 ui1_2x.it_i1
	...
	RTEAA(l_feature_name, 1074, Current, 0, 2, 14568);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1074, Current, 14568);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ui1_1 = arg1;
	ui1_2 = arg2;
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(10493, dtype))(Current, ui1_1x, ui1_2x)).it_b);
...
EIF_TYPED_VALUE F1075_13666 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_i1
	...
	RTEAA(l_feature_name, 1074, Current, 4, 2, 14569);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1074, Current, 14569);
	RTIV(Current, RTAL);
	RTHOOK(1);
