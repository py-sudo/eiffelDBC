...
extern EIF_TYPED_VALUE F1043_13745(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1043_13745 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1042, Current, 0, 0, 14648);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1042, Current, 14648);
	RTIV(Current, RTAL);
	RTHOOK(1);
