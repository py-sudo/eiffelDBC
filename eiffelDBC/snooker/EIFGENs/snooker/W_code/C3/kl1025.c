...
extern EIF_TYPED_VALUE F1025_13369(EIF_REFERENCE);
...
RTOID (F1025_13369)
EIF_TYPED_VALUE F1025_13369 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1024, Current, 0, 0, 14261);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1024, Current, 14261);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
